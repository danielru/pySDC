...
class diffusion_spectral(ptype):
    """
    ...
    def __init__(self, problem_params, dtype_u, dtype_f):
        ...
        super(diffusion_spectral, self).__init__(1, dtype_u, dtype_f, problem_params)
    ...
    def u_exact(self, t):
        ...
        me.values[0] = np.exp(-self.params.nu*self.params.kappa**2*t)
        return me
    ...
    def eval_f(self, u, t):
        ...
        f.values[0] = -(self.params.nu*self.params.kappa**2)*x1
        return f
    ...
    def solve_system(self, rhs, dt, u0, t):
        ...
        u = self.dtype_u(u0)
        x1 = rhs.values[0]
        u.values[0] = x1/(1.0 + dt*(self.params.nu*self.params.kappa**2))
